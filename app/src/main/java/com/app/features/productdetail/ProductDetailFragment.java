...
public class ProductDetailFragment extends Fragment implements ProductListener {
    ...
    ImageView iv_product, iv_unwish, iv_close;
    ...
    RelativeLayout rl_like, rl_weight, rl_view, rl_send_notify, rl_outOfStock, rl_addCart;
    ...
    private void setProductDetails() {
        ...
        tv_star.setText("4.5");
        tv_rating.setText(category.getRate()+" Rating");
